...
> = {
  "sigma-1x": [
    ...
    { name: "Sigma 1x Investor Pitch Deck", type: "PDF", href: "https://kwtagyeqhdxswpztqcsa.supabase.co/storage/v1/object/public/data-room/downloads/sigma-1x-institutional-strategy.pdf" },
  ],
  "sigma-2x": [
    ...
    { name: "Sigma 2x Investor Pitch Deck", type: "PDF", href: "https://kwtagyeqhdxswpztqcsa.supabase.co/storage/v1/object/public/data-room/downloads/sigma-2x-institutional-strategy.pdf" },
  ],
  "both": [
    { name: "Sigma 1x Trader Guide", type: "MD", href: "https://kwtagyeqhdxswpztqcsa.supabase.co/storage/v1/object/public/data-room/downloads/sigma-1x-trader-guide.md" },
    { name: "Sigma 2x Trader Guide", type: "MD", href: "https://kwtagyeqhdxswpztqcsa.supabase.co/storage/v1/object/public/data-room/downloads/sigma-2x-trader-guide.md" },
